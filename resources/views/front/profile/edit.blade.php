...
@section('content')
    <main id="main" class="pt-8 h-full px-28">
        <h2 class="my-4 text-4xl font-semibold text-center font-poppins tracking-widest text-gray-200 dark:text-gray-200">
            <span class="text-white dark:text-orange">Edit  </span> event
        </h2>
                ...
                <div class="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
                    <div class="container mx-auto p-4">
                        <div class="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
                            <h1 class="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">INSERT YOUR EVENT
                                INFORMATION PLEASE</h1>
                            <p class="text-gray-600 dark:text-gray-300 mb-6">Here you can add event's informations.</p>
                            <form action="{{ route('update.event', $event->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="flex mb-4 flex-col md:flex-row -mx-2">
                                    <div class="mb-4 md:mb-0 md:w-1/2 px-2">
                                        ...
                                        <input type="text" value="{{ $event->title }}" id="event-name" placeholder="Event Name" name="title"
                                            class="border p-2 rounded w-full">
                                    </div>
                                    <div class="mb-4 md:mb-0 md:w-1/2 px-2">
                                        <label for="datepicker"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                                        <input type="date" id="datepicker" value="{{ $event->date }}" class="border p-2 rounded w-full"
                                            name="date">
                                    </div>
                                </div>
                                <div class="flex mb-4 flex-col md:flex-row -mx-2">
                                    <div class="mb-4 md:mb-0 md:w-1/2 px-2">
                                        ...
                                        <input type="text" id="event-name" value="{{ $event->location }}" placeholder="addresse" name="location"
                                            class="border p-2 rounded w-full">
                                    </div>
                                    <div class="mb-4 md:mb-0 md:w-1/2 px-2">
                                        <label for="datepicker"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Capacity</label>
                                        <input type="text" id="event-name" value="{{ $event->capacity }}" placeholder="number of seats" name="capacity"
                                            class="border p-2 rounded w-full">
                                    </div>
                                </div>
                                <div class="flex mb-4 flex-col md:flex-row -mx-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <button type="submit"
                                        class="px-4 py-2 bg-gray-900 rounded  text-white hover:bg-blue-600 focus:outline-none transition-colors">
                                        Confirm And Submit
                                    </button>
